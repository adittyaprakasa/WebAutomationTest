...
class Login {
    ...
    @When ("User input form login using (.*) and (.*)")
	def User_input_form_login_using_username_and_password(String username, String password) {
		WebUI.refresh()
